            ...
            <div className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <label className='flex items-center gap-3 p-4 rounded-lg border border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer'>
                        <input
                            ...
                            onChange={(e) =>
                                setContainsAiContent(e.target.checked)
                            }
                        ...
                        <div className='flex-1'>
                            ...
                            <Tooltip delayDuration={200}>
                                ...
                                <TooltipContent
                                    ...
                                    className='max-w-[300px]'
                                >
                                    Check if the website is dedicated to AI
                                    events/news. All news from this source are
                                    about AI.
                                </TooltipContent>
                            </Tooltip>
                        </div>
                    ...
                    <label className='flex items-center gap-3 p-4 rounded-lg border border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer'>
                        <input
                            ...
                            onChange={(e) =>
                                setContainsAfricaContent(e.target.checked)
                            }
                            className='w-5 h-5 text-cyan-600 rounded focus:ring-cyan-500'
                        />
                        <div className='flex-1'>
                            ...
                            <Tooltip delayDuration={200}>
                                ...
                                <TooltipContent
                                    ...
                                    className='max-w-[300px]'
                                >
                                    Check if the website contains news about
                                    Africa. Not all news may be about AI.
                                </TooltipContent>
                            </Tooltip>
                        </div>
                    </label>
                ...
                <div className='mt-4 space-y-2'>
                    {addSourceMutation.isError && (
                        <Alert
                            variant='destructive'
                            className='rounded-lg self-center flex items-center'
                        >
                            <X className='w-5 h-5' />
                            <AlertDescription>
                                {
                                    (addSourceMutation.error as any)?.response
                                        ?.data
                                }
                            </AlertDescription>
                        </Alert>
                    ...
                    {addSourceMutation.isSuccess && (
                        <Alert className='rounded-lg'>
                            ...
                            <AlertDescription>
                                Source added! Processing may take a few minutes.
                            </AlertDescription>
                        </Alert>
                    )}
                </div>
