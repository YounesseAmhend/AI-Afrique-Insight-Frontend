...
const categories = ["All", "Research", "Industry", "Policy", "Hardware", "Media", "Transportation", "Language"]
    ...
    return (
      <section className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground">There was an error loading the news articles. Please try again later.</p>
        </div>
      </section>
    )
  }
